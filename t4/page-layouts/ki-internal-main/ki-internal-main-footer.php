    ...
    <div id="myOverlay" class="overlay">
        <div class="overlay-content">
            <span class="closebtn" title="Close Overlay"><!-- span class="esc">esc</span>--><i class="fas fa-times"></i></span>
            <form action="" id="ki-js-main-search-modal-form">
    ...
    <!-- Footer -->
    <footer id="footer" class="page-footer font-small mdb-color pt-4 bg-primary text-white">
            ...
            <div class="row text-center text-md-left mt-3 pb-3">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="https://goo.gl/forms/5ptepXm6xTYvicWL2">Share your story<svg viewBox="0 0 16 16" width="16" height="16" class="icon-arrow"><path style="fill: #eee;" d="M7.2 12.73l-1.41-1.41 3.29-3.29-3.29-3.29L7.2 3.32l4.71 4.71-4.71 4.7z"></path></svg></a></li>
                ...
                <h6 class="text-uppercase mb-4 font-weight-bold">Support</h6>
                    <ul class="list-unstyled">
                        <li><a href="https://servicedesk.keele.ac.uk/tas/public">Service desk<svg viewBox="0 0 16 16" width="16" height="16" class="icon-arrow"><path style="fill: #eee;" d="M7.2 12.73l-1.41-1.41 3.29-3.29-3.29-3.29L7.2 3.32l4.71 4.71-4.71 4.7z"></path></svg></a></li>
                        <li><a href="/communications">Communications<svg viewBox="0 0 16 16" width="16" height="16" class="icon-arrow"><path style="fill: #eee;" d="M7.2 12.73l-1.41-1.41 3.29-3.29-3.29-3.29L7.2 3.32l4.71 4.71-4.71 4.7z"></path></svg></a></li>
                        <li><a href="/websupport">Web and CMS<svg viewBox="0 0 16 16" width="16" height="16" class="icon-arrow"><path style="fill: #eee;" d="M7.2 12.73l-1.41-1.41 3.29-3.29-3.29-3.29L7.2 3.32l4.71 4.71-4.71 4.7z"></path></svg></a></li>
                        <li><a href="/staffsupport">Staff counselling<svg viewBox="0 0 16 16" width="16" height="16" class="icon-arrow"><path style="fill: #eee;" d="M7.2 12.73l-1.41-1.41 3.29-3.29-3.29-3.29L7.2 3.32l4.71 4.71-4.71 4.7z"></path></svg></a></li>
                    </ul>
                <!-- <h6 class="text-uppercase mb-4 font-weight-bold">Useful links</h6>
                    <p>
