                                <!-- Nav object 598 is pulling instances of the below into it -->
                                <a href="<t4 type="content" name="URL link" output="normal" />">
                                    <li class="media mb-3">
                                        <img class="ki-uec__img mr-3 rounded d-none d-md-block" src="<t4 type="content" name="Image: 960px x 640px" output="file" modifiers="" />" alt="<t4 type="content" name="Image caption" output="normal" modifiers=""  />">
